...
<body>
    ...
    <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow" aria-label="Main navigation">
        <a class="navbar-brand col-md-3 col-lg-2 mr-0 px-3" href="#">BSF COUTURE</a>
    ...
    <div class="container-fluid">
        <div class="row">
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse" aria-label="Sidebar navigation">
